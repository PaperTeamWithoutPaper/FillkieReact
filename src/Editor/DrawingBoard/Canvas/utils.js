...
function douglasPeuckerStep(points, first, last, tolerance, simplified) {
 ...
 */
export function compressPoints(points, tolerance = 10) {
 ...
 */
export function checkLineIntersection(point1Start, point1End, point2Start, point2End) {
    ...
    const denominator = (point2End.y - point2Start.y) * (point1End.x - point1Start.x) -
 ...
 */
export function isInnerBox(box, point) {
 ...
 */
export function isSelectable(shape) {
